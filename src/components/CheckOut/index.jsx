...
import image from "../../assets/images/promo1.png";
import "../../assets/css/animaciones.css";

function CheckOut() {
  document.title = `Pago y envío`;
        ...
        <div className="row py-lg-2">
          <div>
            <Badge bg="primary" className="m-1">
              <h6>
                Su ID de compra ${OrderID} Total de articulos: {itemsTotal()}
              </h6>
            </Badge>
              ...
              <div className="row g-3">
                ...
                <div className="col-12">
                  <label htmlFor="email" className="form-label">
                    Correo electrónico <span className="text-muted"></span>
                  </label>
                  <input
